...
<section class="assessment-con">
    <section class="list-panel">
        ...
        <ul class="fill-bd">
            <li class="fill-item">
                ...
                <input type="hidden" placeholder="" value="" class="fill-input" id="hiddenResidentialAreaName"/></input>
                <input type="hidden" class="fill-input" id="xiaoquID" value=""/>
            </li>
            <li class="fill-item">
    ...
    <section class="list-panel">
        ...
        <ul class="fill-bd">
            <li class="fill-item">
                ...
                <input class="fill-input" type="text" id="ldh" value="" placeholder="如：B1、3号楼" />
            </li>
            <li class="fill-item">
                <div class="fill-title">门<span class="t3">牌</span>号:</div>
                <input class="fill-input" type="text" id="hh" value="" placeholder="如：1单元1002" />
            </li>
            <li class="fill-item">
                <div class="fill-title">所在楼层:</div>
                <input class="fill-input" type="text" id="szlc" onblur="validszlc()" value="" placeholder="如：12" />
                <span class="fill-span">层</span>
            </li>
            <li class="fill-item">
                <div class="fill-title">总<span class="t3">楼</span>层:</div>
                <input class="fill-input" type="text" id="zlc" onblur="validZLC()" value="" placeholder="如：17" />
                <span class="fill-span">层</span>
            </li>
            <li class="fill-item">
                <div class="fill-title">建成年代:</div>
                <input class="fill-input" type="text" id="jcnd" value="" placeholder="如：2004" />
    ...
    <section class="assessment-foot full-center">
        <a class="btn btn-blue" id="doPinggu" onclick="doPinggu()">我要评估</a>
...
$(function () {
        ...
        //下拉框自动补全
        $("#name").focus(function () {
        $(this).autocomplete("GuzhiBuyer/loadLikeSreachxiaoqu_noLogin", {
            width: 200,
            scroll: true,
            matchCase: false,
            scrollHeight: 300,
    ...
    function onmouseout_xqmc() {
        ...
        if(xqid==null||xqid ==""){
            if($("#name").val()!=null&&$("#name").val()!=""&&$("#name").val()!="如：五栋大楼"){
                $.ajax({
                    type: "GET",
                    url: "GuzhiBuyer/loadLikeSreachxiaoqu_noLogin",
                    data: {
                        "v": $("#name").val(),
                        "city":"beijing"
                    },
        ...
        if (xqmc == null || xqmc == "") {
            ...
            $.ajax({
                type: "GET",
                url: "GuzhiBuyer/findTeshuyinsu_noLogin",
                data: {
                    "city": "beijing",
                    "cname": xqmc
                },
...
function doPinggu() {
        ...
        var url = "GuzhiBuyer/buyerXunjiaDetail_noLogin?xqmc="
                + xqmc
                + "&ldh="
                + ldh
                + "&hh="
